"""
Django settings for cash_demo2 project.
...
SECRET_KEY = '79#=^htlif!6b1d9txjv+5c)xst)xwej@4_vw+#8g!y*tr+0(x'
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.getenv("MYSQL_DEFAULT_PASSWORD", "1234abc@"),
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'cash_demo.cash_user.authentication.JWTAuthentication',
